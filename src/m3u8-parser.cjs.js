...
var decodeB64ToUint8Array__default = /*#__PURE__*/ _interopDefaultLegacy(
...
var ParseStream = /*#__PURE__*/ (function (_Stream) {
  ...
  _proto.push = function push(line) {
    ...
    var newLines = this.tagMappers.reduce(
      function (acc, mapper) {
    ...
    newLines.forEach(function (newLine) {
      ...
      if (match) {
        ...
        if (match[1]) {
          ...
          if (event.attributes.BANDWIDTH) {
            event.attributes.BANDWIDTH = parseInt(
              event.attributes.BANDWIDTH,
              10
            );
          }
      ...
      if (match) {
        ...
        if (match[1]) {
          event.attributes = parseAttributes(match[1]);
          event.attributes["TIME-OFFSET"] = parseFloat(
            event.attributes["TIME-OFFSET"]
          );
      ...
      if (match && match[1]) {
        ...
        if (event.attributes.hasOwnProperty("SKIPPED-SEGMENTS")) {
          event.attributes["SKIPPED-SEGMENTS"] = parseInt(
            event.attributes["SKIPPED-SEGMENTS"],
            10
          );
        }
...
var Parser = /*#__PURE__*/ (function (_Stream) {
          ...
          ((
            {
              ...
              key: function key() {
                ...
                if (
                  ...
                  this.manifest.contentProtection =
                    this.manifest.contentProtection || {}; // TODO: add full support for this.
                ...
                if (entry.attributes.KEYFORMAT === widevineUuid) {
                  ...
                  this.manifest.contentProtection["com.widevine.alpha"] = {
                    ...
                    pssh: decodeB64ToUint8Array__default["default"](
              ...
              "server-control": function serverControl() {
                var attrs = (this.manifest.serverControl = camelCaseKeys(
                  entry.attributes
                ));
  ...
  _proto.warnOnMissingAttributes_ = function warnOnMissingAttributes_(
    identifier,
    attributes,
    required
  ) {
    ...
    if (missing.length) {
      this.trigger("warn", {
        message:
          identifier + " lacks required attribute(s): " + missing.join(", "),
      });
    }
  };
  /**
